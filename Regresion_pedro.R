...
#Ejercicio 1
#Sí, es posible inferir respuestas asociadas a sucesos y fenómenos pasados a partir de restos materiales presentes.
#Los restos materiales pueden proporcionar una amplia gama de información, como patrones de asentamiento, prácticas religiosas, sistemas de producción, tecnología utilizada, interacciones comerciales y más.
#Sin embargo, es importante destacar que la interpretación de los restos materiales puede ser compleja y está sujeta a interpretaciones múltiples

#Ejercicio 2
#No, el análisis de correlación lineal de Pearson no establece ningún tipo de relación causa-efecto entre variables. 
#Este método simplemente cuantifica la fuerza y la dirección de la relación lineal entre dos variables cuantitativas.

#Ejercicio 3
#La causalidad se refiere a la relación entre una causa y un efecto, donde un cambio en la causa produce un cambio en el efecto de manera predecible y consistente. 
#En otras palabras, la causalidad implica que un fenómeno (la causa) es responsable de la ocurrencia de otro fenómeno (el efecto). 
#Este concepto es fundamental en la ciencia y la investigación, ya que permite entender y explicar cómo funcionan las cosas en el mundo.
...
#Ejercicio 6
#En el contexto de la regresión múltiple, donde hay más de una variable independiente, se utiliza un plano de regresión en lugar de una recta. 
#El plano de regresión es una superficie tridimensional que representa la relación entre la variable dependiente y dos o más variables independientes.
...
#Esto significa que cuando la variable independiente es cero, la variable dependiente también es cero. 
...
#Ejercicio 11
#El análisis de regresión lineal utiliza el método de mínimos cuadrados para calcular los valores de los parámetros que configuran la recta de regresión. 
#Este método minimiza la suma de los cuadrados de las diferencias entre los valores observados y los valores predichos por el modelo. 
#Básicamente, busca la recta que mejor se ajusta a los datos minimizando la distancia vertical entre los puntos de datos y la recta.
...
#El resultado de esta prueba nos indicará si los residuos siguen una distribución normal o no, basándose en el valor p.
...
#Ejercicio 18
#Cuando las estimaciones arrojadas por un modelo lineal son menos precisas en un rango de valores con respecto a otro, sugiere la presencia de heterocedasticidad. 
...
#lo que significa que la dispersión de los errores varía a lo largo del rango de los valores de la variable explicativa. Por el contrario, en presencia de homocedasticidad, 
